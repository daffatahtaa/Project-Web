                    ...
                    <div class="compressed">
                        <div class="navbar-header">
                            ...
                            <a href="#" class="navbar-brand compressed">
                                <img src="assets/img/Artboard 1.png" alt="" data-src="assets/img/Artboard 1.png"
                                    data-src-retina="assets/img/Artboard 1.png" width="119" height="22" /></a>
                        </div>
                    ...
                    <div class="compressed">
                        <div class="navbar-header">
                            ...
                            <a href="index.php" class="navbar-brand">
                                <img src="assets/img/Artboard 1.png" data-src="assets/img/Artboard 1.png" data-src-retina="assets/img/Artboard 1.png"
                ...
                <div class="tp-banner" id="home">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="assets/img/bg/Indonesia-backgrounds-4k.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center"
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="assets/img/bg/chris-fowler-641837-unsplash.jpg" alt="slidebg2" data-bgfit="cover" data-bgposition="center center"
                                data-bgrepeat="no-repeat">
                            
                                <!-- LAYERS -->

                            <div class="tp-caption mediumlarge_light_white_center sft tp-resizeme slider" data-x="center"
                                data-hoffset="0" data-y="120" data-speed="200" data-start="800" data-easing="Power4.easeOut"
                                data-endspeed="300" data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                <h2 class="text-white custom-font title ">
                                    Lokal <br>
                                    Atau<br>
                            ...
                            <!-- <div class="tp-caption fade slider tp-resizeme slider" data-x="center" data-hoffset="0"
                                data-y="380" data-speed="500" data-start="800" data-easing="Power4.easeOut" data-endspeed="300"
                                data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                <a class="text-white m-r-10">Silahkan lihat slide selanjutnya untuk mengetahui lebih lanjut</a>
                            </div> -->
                        ...
                        <li data-transition="fade" data-slotamount="5" data-masterspeed="700">
                            ...
                            <img src="assets/img/bg/sutirta-budiman-527416-unsplash.jpg" alt="slidebg2" data-bgfit="cover" data-bgposition="center center"
                                data-bgrepeat="no-repeat">
                            
                            <!-- LAYERS -->
                            <div class="tp-caption mediumlarge_light_white_center sft tp-resizeme slider" data-x="center"
                                data-hoffset="0" data-y="200" data-speed="200" data-start="800" data-easing="Power4.easeOut"
                                data-endspeed="300" data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                <h2 class="text-white custom-font title ">
                                    Dengan Harga Relatif Terjangkau<br>
                                    tertarik?</h2>
                            </div>
                            <div class="tp-caption fade slider tp-resizeme slider" data-x="center" data-hoffset="0"
                                data-y="370" data-speed="200" data-start="800" data-easing="Power4.easeOut" data-endspeed="300"
                                data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                <a class="text-white m-r-10">Silahkan daftar jika belum punya akun :</a>
                            </div>
                            <div class="tp-caption sfb slider tp-resizeme slider" data-x="center" data-hoffset="0"
                                data-y="390" data-speed="500" data-start="1000" data-easing="Power4.easeOut"
                                data-endspeed="300" data-endeasing="Power1.easeIn" data-captionhidden="off" style="z-index: 6">
                                
                                <a href="register.php" class="btn btn-info btn-lg  btn-large m-r-10">Daftar Sekarang</a>
                            </div>
                        </li>
                    </ul>
